 ...
 * @mixin \think\View
 * @method static \taoser\View engine(string $type = null) 获取模板引擎
 * @method static \taoser\View assign(string|array $name, mixed $value = null) 模板变量赋值
 * @method static \taoser\View filter(\think\Callable $filter = null) 视图过滤
