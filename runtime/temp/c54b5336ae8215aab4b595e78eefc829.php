<?php /*a:6:{s:55:"E:\github\TaoLer\app\index\view\taoler\login\login.html";i:1737273662;s:55:"E:\github\TaoLer\app\index\view\taoler\public\base.html";i:1760276314;s:57:"E:\github\TaoLer\app\index\view\taoler\public\header.html";i:1760276314;s:55:"E:\github\TaoLer\app\index\view\taoler\public\menu.html";i:1744610627;s:57:"E:\github\TaoLer\app\index\view\taoler\public\footer.html";i:1737273662;s:53:"E:\github\TaoLer\app\index\view\taoler\public\js.html";i:1737273662;}*/ ?>
<!--
  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title">
        <li class="layui-this"><?php echo lang('login'); ?></li>
        <li><a href="<?php echo url('user_reg'); ?>"><?php echo lang('sign up'); ?></a></li>
      </ul>
      <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
        <?php if(config('taoler.config.is_login') == 1): ?>
            ...
            <form method="post" >
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" id="L_name" name="name" required lay-verify="required" autocomplete="off" class="layui-input" placeholder="<?php echo lang('mail/username/mobile'); ?>">
                </div>
              </div>
              <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label"><?php echo lang('password'); ?></label>
                <div class="layui-input-inline">
                  <input type="password" id="L_pass" name="password" required lay-verify="required" autocomplete="off" class="layui-input" placeholder="<?php echo lang('please input the password'); ?>">
                </div>
              </div>
			      <?php if(config('taoler.config.login_captcha') == 1): ?>
              <div class="layui-form-item">
                ...
                <div class="layui-form-mid layui-word-aux" style="padding-top: 0px !important;">                 
					        <img src="<?php echo captcha_src(); ?>" style="float:left; cursor:pointer;" id="captcha" alt="captcha"  />
                </div>
              </div>
			      <?php endif; ?>
			        <div class="layui-form-item">
                <input type="checkbox" name="remember" title="<?php echo lang('remember password'); ?>" lay-skin="primary"  lay-filter="remember" value="1">
              </div>
              <div class="layui-form-item">
                <button type="submit" name="submit" class="layui-btn" lay-filter="user-login" lay-submit id="login"><?php echo lang('login now'); ?></button>
                <span style="padding-left:20px;">
                  <a href="<?php echo htmlentities((string) app('request')->domain()); ?><?php echo url('user_forget'); ?>"><?php echo lang('forget password'); ?>？</a>
                </span>
              </div>
              <?php echo hook('socialhook'); ?>
            </form>
          </div>
        </div>
        <?php else: ?>
